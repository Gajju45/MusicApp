...
public class Weekly extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        albumList.add(new com.example.musicapp.AlbumDetail("Artist1", "Music 1",R.raw.number_one));
        albumList.add(new com.example.musicapp.AlbumDetail("Artist2", "Music 2",R.raw.number_two));
        albumList.add(new com.example.musicapp.AlbumDetail("Artist3", "Music 3",R.raw.number_two));
        albumList.add(new com.example.musicapp.AlbumDetail("Artist4", "Music 4",R.raw.number_one));
